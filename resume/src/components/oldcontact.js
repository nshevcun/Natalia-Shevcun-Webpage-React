...
class OldContact extends React.Component {
    render() {
        return(
            <React.Fragment>
                <section>

                    {/* This is an older contact form with more "fun" actions. 
                    I may go back to using it once I get a more basic version to work. 
                    For now it will exist as an unused component. */}
